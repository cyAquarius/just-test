 ...
 * <p>不对消费方提供兼容承诺。</p>
 */
final class JustTestProjectFeignOkHttp {

    static final String PROPERTY_SOURCE_NAME = "justTestProjectFeignOkHttp";
    ...
    private JustTestProjectFeignOkHttp() {
    }
    ...
    static void disableOkHttp(Environment environment) {
        if (!(environment instanceof ConfigurableEnvironment)) {
            throw new IllegalStateException(
                    "[JustTest] @JustTestProject cannot disable Feign OkHttp because the "
