package com.just.test.smarttest.parallel.first;
...
class ParallelFirstSmartTest implements SmartTestLifecycle {

    @CaseSource
    void overlapsAnotherSmartTestClass(CaseContext context) throws Exception {
        ParallelClassCoordinator.overlap("first", context.getString("marker"));
    }
